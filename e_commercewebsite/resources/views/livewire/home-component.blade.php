		...
		<div class="container">
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2" style="width: 292px;">
						
						<div class="product-thumnail">
							<a href="{{ route('shop', $product)}}" title="{{$product->name}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
							...
							<div class="wrap-btn">
								<a href="{{ route('shop', $product)}}" title="{{$product->name}}" class="function-link">quick view</a>
							</div>
						</div>
					...
					<div class="wrap-product-tab tab-style-1">
						...
						<div class="tab-contents">
							...
							<div class="tab-content-item active" id="fashion_1a">
								<div class="wrap-products slide-carousel  style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
